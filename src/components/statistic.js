  ...
  return (
    ...
    <ul class="statistic__text-list">
      ...
      <li class="statistic__text-item">
        ...
        <p class="statistic__item-text">${convertHours(totalDuration)}<span class="statistic__item-description">h</span> ${ convertMinutes(totalDuration)} <span class="statistic__item-description">m</span></p>
      </li>
      <li class="statistic__text-item">
